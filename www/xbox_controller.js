///////////////////////////////////////////////////////////////////////////////
// Simple XboxControllerExtension extension for Forge Viewer
...
class XboxControllerExtension extends Autodesk.Viewing.Extension {
    ...
    load() {
        console.log('XboxControllerExtension is loaded!');
        setup_gamepad();
        return true;
    }
    unload() {
        console.log('XboxControllerExtension is now unloaded!');
        return true;
    }
}
